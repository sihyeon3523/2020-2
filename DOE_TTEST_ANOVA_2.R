...
setwd("C:/Users/user/Google 드라이브/Lecture notes/DOE/2018") # change directory
...
plot(fit,2) # Check the homogeneity of variance assumption
plot(fit,1) # Check the normality assumption

install.packages("car") # install a required package to run leven test
require(car)
leveneTest(y ~ factor(group), data = data)
